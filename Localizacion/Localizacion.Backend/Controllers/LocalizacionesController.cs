...
namespace asp_servicios.Controllers
{
    ...
    {
        private ILocalizacionesAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public LocalizacionesController(ILocalizacionesAplicacion? iAplicacion,
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Localizaciones>(
